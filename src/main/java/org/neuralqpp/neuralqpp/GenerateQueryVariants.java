...
import static org.neuralqpp.common.CommonVariables.FIELD_FULL_BOW;
import org.neuralqpp.common.EnglishAnalyzerSmartStopWords;
import org.neuralqpp.common.TRECQuery;
import org.neuralqpp.common.TRECQueryParse;
import java.io.File;
...
public class GenerateQueryVariants {
    ...
    public GenerateQueryVariants(Properties prop) throws IOException, Exception {
        ...
        if (null == stopFilePath)
            engAnalyzer = new org.neuralqpp.common.EnglishAnalyzerSmartStopWords();
        else
            engAnalyzer = new org.neuralqpp.common.EnglishAnalyzerSmartStopWords(stopFilePath);
...
//            resFileWriter.close();
            ...
            switch(varGen.toLowerCase()) {
                case "rlm":
                    ...
                    resBuffer = new StringBuffer();
                    queryVariantList = qvrlm.createVariantsRLM(topRetDocs, luceneQuery, varLen);
//                    resBuffer.append(query.qid).append(" ::: ").append(luceneQuery.toString(fieldToSearch)).append("\n");
                ...
                case "w2v":
                    ...
                    resBuffer = new StringBuffer();
                    queryVariantList = qvwv.createVariantsW2V(luceneQuery, varLen);
//                    resBuffer.append(query.qid).append(" ::: ").append(luceneQuery.toString(fieldToSearch)).append("\n");
                    for (String variant : queryVariantList)
                        resBuffer.append(query.qid).append("\t").
                                append(variant).append("\n");
    ...
    public static void main(String[] args) throws IOException, Exception {
        ...
        GenerateQueryVariants gqv = new GenerateQueryVariants(prop);
